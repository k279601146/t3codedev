// This file mostly exists because we want dev mode to say "Bahew (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Bahew (Dev)" : "Bahew (Alpha)";
const APP_BUNDLE_ID = isDevelopment ? "com.bahew.bahew.dev" : "com.bahew.bahew";
