...
export function resolveBundledEngineConfig(
  ...
  const spawnEnvPatch: Record<string, string> = {
    ...
    [`CODEX_MODEL_PROVIDERS_${COMMERCIAL_ENGINE_PROVIDER_ID.toUpperCase()}_REQUIRES_OPENAI_AUTH`]:
      "false",
    [`CODEX_MODEL_PROVIDERS_${COMMERCIAL_ENGINE_PROVIDER_ID.toUpperCase()}_REQUEST_MAX_RETRIES`]:
      "0",
    [`CODEX_MODEL_PROVIDERS_${COMMERCIAL_ENGINE_PROVIDER_ID.toUpperCase()}_STREAM_MAX_RETRIES`]:
      "5",
    ...
    CODEX_MODEL_PROVIDERS_OPENAI_REQUEST_MAX_RETRIES: "0",
    CODEX_MODEL_PROVIDERS_OPENAI_STREAM_MAX_RETRIES: "5",
