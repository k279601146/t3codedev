...
// Memoized for prompt-cache stability â€?captures the date once at session start.
...
// stale date after midnight vs. ~entire-conversation cache bust â€?stale wins).
export const getSessionStartDate = memoize(getLocalISODate)

// Returns "Month YYYY" (e.g. "February 2026") in the user's local timezone.
// Changes monthly, not daily â€?used in tool prompts to minimize cache busting.
