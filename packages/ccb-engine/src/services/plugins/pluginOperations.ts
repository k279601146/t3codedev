...
import type { LoadedPlugin, PluginManifest } from "../../types/plugin.ts"
...
} from "../../utils/plugins/cacheUtils.ts"
import {
  findReverseDependents,
  formatReverseDependentsSuffix,
} from "../../utils/plugins/dependencyResolver.ts"
import {
...
import { deletePluginDataDir } from "../../utils/plugins/pluginDirectories.ts"
import {
...
} from "../../utils/plugins/pluginInstallationHelpers.ts"
import {
  cachePlugin,
  ...
  loadAllPlugins,
  loadPluginManifest,
} from "../../utils/plugins/pluginLoader.ts"
import { deletePluginOptions } from "../../utils/plugins/pluginOptionsStorage.ts"
...
import { calculatePluginVersion } from "../../utils/plugins/pluginVersioning.ts"
import type {
