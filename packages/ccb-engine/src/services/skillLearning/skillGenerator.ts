...
import { clearSkillIndexCache } from "../skillSearch/localSearch.ts"
import type { Instinct } from "./instinctParser.ts"
import { buildLearnedSkillName, normalizeSkillName } from "./learningPolicy.ts"
import {
  compareExistingArtifacts,
  scoreArtifactOverlap,
  type ExistingSkill,
} from "./skillLifecycle.ts"
import type { LearnedSkillDraft, SkillLearningScope } from "./types.ts"
