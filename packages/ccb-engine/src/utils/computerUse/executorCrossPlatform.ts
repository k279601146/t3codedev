...
import { CLI_CU_CAPABILITIES, CLI_HOST_BUNDLE_ID } from "./common.ts"
import { validateHwnd } from "./win32/shared.ts"
import { loadPlatform } from "./platforms/index.ts"
...
function getBoundHwndStr(): string | null {
  ...
  try {
    const { getBoundHwnd } =
      require('./platforms/win32.ts') as typeof import('./platforms/win32.ts')
    return getBoundHwnd()
  } catch {
    return null
  }
...
function getAccessibilityText(): string | undefined {
  ...
  try {
    ...
    const { captureAccessibilitySnapshot } =
      require('./win32/accessibilitySnapshot.ts') as typeof import('./win32/accessibilitySnapshot.ts')
...
$i = New-Object MUp+INPUT; $i.type=0; $i.mi.dwFlags=0x0004; [MUp]::SendInput(1, @($i), [Runtime.InteropServices.Marshal]::SizeOf($i)) | Out-Null`,
    ...
    async openTerminal(opts: {
      ...
      try {
        const { listWindows: enumWindows } =
          require('./win32/windowEnum.ts') as typeof import('./win32/windowEnum.ts')
        const { bindWindow } =
          require('./platforms/win32.ts') as typeof import('./platforms/win32.ts')
    ...
    async statusIndicator(
      ...
      try {
        const ind =
          require('./win32/inputIndicator.ts') as typeof import('./win32/inputIndicator.ts')
    ...
    async virtualKeyboard(opts: {
      ...
      try {
        ...
        const wm =
          require('./win32/windowMessage.ts') as typeof import('./win32/windowMessage.ts')
        const { VK_MAP } =
          require('./win32/shared.ts') as typeof import('./win32/shared.ts')
    ...
    async virtualMouse(opts: {
      ...
      try {
        ...
        const wm =
          require('./win32/windowMessage.ts') as typeof import('./win32/windowMessage.ts')
        const vc =
          require('./win32/virtualCursor.ts') as typeof import('./win32/virtualCursor.ts')
    ...
    async clickElement(query: {
      ...
      try {
        ...
        const { clickElement: uiaClick } =
          require('./win32/uiAutomation.ts') as typeof import('./win32/uiAutomation.ts')
        // Get window title for UIA lookup
        const windows = require('./win32/windowEnum.ts').listWindows() as {
          hwnd: string
          title: string
        }[]
        ...
        const { sendClick } =
          require('./win32/windowMessage.ts') as typeof import('./win32/windowMessage.ts')
        const editHwnd = require('./win32/windowMessage.ts').findEditChild(hwnd)
