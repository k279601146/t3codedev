...
import type { ToolResultBlockParam } from "../../../../Tool.ts"
import { buildTool } from "../../../../Tool.ts"
import { lazySchema } from "../../../../utils/lazySchema.ts"
import { notifyAutomationStateChanged } from "../../../../utils/sessionState.ts"
import { SLEEP_TOOL_NAME, DESCRIPTION, SLEEP_TOOL_PROMPT } from "./prompt.ts"
...
function hasQueuedWakeSignal(): boolean {
  const queue =
    require('../../../../utils/messageQueueManager.ts') as typeof import('../../../../utils/messageQueueManager.ts')
