...
import type { InputEvent, Key } from "../core/events/input-event.ts"
...
const useInput = (inputHandler: Handler, options: Options = {}) => {
  ...
  // leaving the terminal in cooked mode 鈥?keystrokes echo and the cursor is
  ...
  // listener would re-append on false鈫抰rue, moving it behind listeners
  // that registered while it was inactive 鈥?breaking
