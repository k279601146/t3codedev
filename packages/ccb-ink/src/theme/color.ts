import { type ColorType, colorize } from "../core/colorize.ts"
import type { Color } from "../core/styles.ts"
import { getTheme, type Theme, type ThemeName } from "./theme-types.ts"
