...
import { useIsInsideModal, useModalScrollRef } from "./modalContext.ts";
...
export function Tabs({
  ...
  // the -> hint only engage when at least one child has opted in —
  // otherwise pressing down on a legacy tab would strand the user with nav disabled.
