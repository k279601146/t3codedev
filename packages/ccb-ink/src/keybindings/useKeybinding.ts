...
import type { InputEvent } from "../core/events/input-event.ts"
import { type Key } from "../core/events/input-event.ts"
 ...
 * The binding (keystroke 鈫?action) comes from config.
 *
...
export function useKeybindings(
  // Handler returning `false` means "not consumed" 鈥?the event propagates
