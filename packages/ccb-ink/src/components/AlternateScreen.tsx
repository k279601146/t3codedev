...
import { TerminalWriteContext } from "../hooks/useTerminalNotification.ts";
 ...
 * - Optionally enables SGR mouse tracking (wheel + click/drag) 鈥?events
 ...
 * and similar temporary fullscreen views 鈥?the main screen is preserved.
 *
...
export function AlternateScreen({ children, mouseTracking = true }: Props): React.ReactNode {
  ...
  // first onRender fires BEFORE this effect 鈥?writing a full frame to the
