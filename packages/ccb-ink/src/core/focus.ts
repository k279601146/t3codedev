 ...
 *
 * Pure state 鈥?tracks activeElement and a focus stack. Has no reference
 ...
 * the FocusManager 鈥?like browser's `node.getRootNode()`.
 */
 ...
 * Like browser's `node.ownerDocument` 鈥?focus belongs to the root.
 */
