...
// logError stub 鈥?replaced from business dependency; use injected logger in production
 ...
 * - Capture handlers are prepended (unshift) 鈫?root-first
 * - Bubble handlers are appended (push) 鈫?target-first
 *
 ...
 * resolveEventTimeStamp 鈥?mirroring how react-dom's host config reads
