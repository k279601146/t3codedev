...
# Invoked by ssh via SSH_ASKPASS when Bahew re-runs ssh with a cached password
...
printf 'Bahew ssh-askpass invoked without T3_SSH_AUTH_SECRET.\\n' >&2
exit 1
`;
...
export const ASKPASS_WINDOWS_SCRIPT = `# Invoked by ssh via SSH_ASKPASS (through ssh-askpass.cmd) when Bahew re-runs\r
...
[Console]::Error.WriteLine("Bahew ssh-askpass invoked without T3_SSH_AUTH_SECRET.")\r
exit 1\r
`;
