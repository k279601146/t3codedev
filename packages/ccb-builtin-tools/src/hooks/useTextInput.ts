    ...
    switch (true) {
      case key.escape:
        return () => {
          ...
          // useKeybindings can't shield us via stopImmediatePropagation â€?
      ...
      case key.pageDown:
        ...
        // of moving the cursor â€?no-op here, ScrollKeybindingHandler handles it.
