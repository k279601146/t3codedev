...
import { type GlobalConfig, getGlobalConfig } from "@t3tools/ccb-engine/src/utils/config.ts";
...
const MIGRATIONS: ((c: GlobalConfig) => Notification | undefined)[] = [
  // Sonnet 4.5 â†?4.6 (pro/max/team premium)
  c => {
  ...
  // Opus Pro â†?default, or pinned 4.0/4.1 â†?opus alias. Both land on the
  ...
  c => {
    ...
    return {
      key: 'opus-pro-update',
      text: isLegacyRemap
        ? 'Model updated to Opus 4.7 Â· Set CLAUDE_CODE_DISABLE_LEGACY_MODEL_REMAP=1 to opt out'
