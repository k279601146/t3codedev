/**
 * usePipeRelay â€?Pipe message relay utilities for slave â†?master communication.
 *
...
import { getPipeRelay, isRelayMuted } from "../utils/pipePermissionRelay.ts"
import type { PipeMessage } from "../utils/pipeTransport.ts"
...
/**
 * Hook that provides pipe relay utilities. Safe to call unconditionally â€?
