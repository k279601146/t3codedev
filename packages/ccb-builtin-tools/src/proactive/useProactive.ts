/**
 * useProactive â€?React hook that drives tick generation for proactive mode.
 *
...
import { cancelQueuedAutonomyCommands } from "../utils/autonomyQueueLifecycle.ts"
import { createProactiveAutonomyCommands } from "../utils/autonomyRuns.ts"
  ...
  useEffect(() => {
    ...
    function scheduleTick(): void {
      ...
      timer = setTimeout(() => {
        ...
        if (!shouldTick()) {
          // Reschedule â€?conditions may clear later
          scheduleTick()
          return
        }
