/**
 * Proactive mode â€?tick-driven autonomous agent.
 *
 * State machine: inactive â†?active (â†?paused â†?active) â†?inactive
 *
...
// ---------------------------------------------------------------------------
// Public API â€?consumed by REPL.tsx, PromptInputFooterLeftSide, prompts.ts
// ---------------------------------------------------------------------------
 ...
 *
 * Set to `true` on API errors to prevent tick â†?error â†?tick runaway loops.
