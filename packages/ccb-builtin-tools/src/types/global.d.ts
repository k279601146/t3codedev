...
// ============================================================================
// MACRO â€?Bun compile-time constants injected via bunfig.toml [define] (dev)
...
declare function resolveAntModel(
  model: string,
): import('../utils/model/antModels.ts').AntModel | undefined
declare function getAntModels(): import('../utils/model/antModels.ts').AntModel[]
...
// T â€?Generic type parameter leaked from React compiler output
...
// ============================================================================
// Build-time constants BUILD_TARGET/BUILD_ENV/INTERFACE_TYPE â€?removed (zero runtime usage)

// ============================================================================
// Ink custom JSX intrinsic elements â€?see src/types/ink-jsx.d.ts

// ============================================================================
// Bun text/file loaders â€?allow importing non-TS assets as strings
declare module '*.md' {
