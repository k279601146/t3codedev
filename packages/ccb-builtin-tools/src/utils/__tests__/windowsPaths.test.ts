...
import { windowsPathToPosixPath, posixPathToWindowsPath } from '../windowsPaths.ts'
...
describe('windowsPathToPosixPath', () => {
  ...
  test('converts relative path by flipping backslashes', () => {
    expect(windowsPathToPosixPath('src\\main.ts')).toBe('../../main.ts')
  })
  ...
  test('already-posix relative path passes through', () => {
    expect(windowsPathToPosixPath('../../main.ts')).toBe('../../main.ts')
  })
...
describe('posixPathToWindowsPath', () => {
  ...
  test('converts relative path by flipping forward slashes', () => {
    expect(posixPathToWindowsPath('../../main.ts')).toBe('src\\main.ts')
  })
