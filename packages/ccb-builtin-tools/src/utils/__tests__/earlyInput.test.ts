 ...
 *
 * The earlyInput processChunk() was too simplistic â€?it only checked if the
 ...
 * processChunk indirectly via a fake stdin emit â€?but since that requires a
...
describe('earlyInput escape sequence regression (fix: iTerm2 sequences leaking)', () => {
   ...
   * The actual filtering is exercised by the integration path (stdin â†?processChunk).
   */

  test('DA1 response sequence pattern is documented (CSI ? ... c)', () => {
    // \x1b[?64;1;2;4;6;17;18;21;22c â€?previously leaked as "?64;1;2;4;6;17;18;21;22c"
  ...
  test('XTVERSION DCS sequence pattern is documented (ESC P ... ESC \\)', () => {
    // \x1bP>|iTerm2 3.6.4\x1b\\ â€?previously leaked as ">|iTerm2 3.6.4"
