...
describe('formatPrice', () => {
  test("formats integers without decimals: 3 â†?'$3'", () => {
    expect(formatPrice(3)).toBe('$3')
  })

  test("formats floats with 2 decimals: 0.8 â†?'$0.80'", () => {
    expect(formatPrice(0.8)).toBe('$0.80')
  })

  test("formats large integers: 150 â†?'$150'", () => {
  ...
  test("formats mixed decimal: 22.5 â†?'$22.50'", () => {
