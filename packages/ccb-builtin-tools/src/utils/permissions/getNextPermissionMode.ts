...
import { transitionPermissionMode } from "./permissionSetup.ts"
 ...
 *   default â†?acceptEdits â†?plan â†?auto â†?bypassPermissions â†?default
 */
export function getNextPermissionMode(
  ...
  switch (toolPermissionContext.mode) {
    ...
    default:
      // Covers any future modes â€?always fall back to default
      return 'default'
  }
}
