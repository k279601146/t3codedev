import { resetSdkInitState } from "@t3tools/ccb-engine/src/bootstrap/state.ts"
...
function getHooksFromAllowedSources(): HooksSettings {
  ...
  // Plugin hooks (registered channel, hooks.ts:1391) are NOT affected â€?
  ...
  // hooks are gated at REGISTRATION (runAgent.ts:~535) by agent source â€?
