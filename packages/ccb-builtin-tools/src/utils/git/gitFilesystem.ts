...
import { parseGitConfigValue } from "./gitConfigParser.ts"
...
// ---------------------------------------------------------------------------
// GitFileWatcher â€?watches git files and caches derived values.
// Lazily initialized on first cache access. Invalidates all cached
// values when any watched file changes.
//
// Watches:
//   .git/HEAD          â€?branch switches, detached HEAD
//   .git/config        â€?remote URL changes
//   .git/refs/heads/<branch> â€?new commits on the current branch
//
