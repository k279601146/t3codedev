...
//
// All commands ï¿?user input, task notifications, orphaned permissions ï¿?go
...
/** Frozen snapshot ï¿?recreated on every mutation for useSyncExternalStore. */
 ...
 * Accepts an optional `filter` ï¿?only commands passing the predicate are considered.
 */
 ...
 * prompt. Superset of editable ï¿?channel messages show (so the keyboard user
...
// ============================================================================
// Backward-compatible aliases (deprecated ï¿?prefer new names)
// ============================================================================
