 ...
 *
 * No window-bound input (sendChar/sendKey/sendClick/sendText) â€?macOS
...
import { requireComputerUseInput } from "../inputLoader.ts"
import { requireComputerUseSwift } from "../swiftLoader.ts"

// ---------------------------------------------------------------------------
// Input â€?delegate to @ant/computer-use-input darwin backend
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Screenshot â€?delegate to @ant/computer-use-swift
// ---------------------------------------------------------------------------
...
const screenshot: ScreenshotPlatform = {
  ...
  // it through this interface yet â€?the swift module's captureExcluding
  // handles most use cases.
}

// ---------------------------------------------------------------------------
// Display â€?delegate to @ant/computer-use-swift
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Apps â€?delegate to @ant/computer-use-swift
// ---------------------------------------------------------------------------
