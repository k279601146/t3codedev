/**
 * Python Bridge Client â€?manages a long-lived Python subprocess for Windows
...
/**
 * Synchronous call â€?blocks the event loop. Use sparingly.
...
// NOTE: No process exit handlers here â€?the platform-level win32.ts
