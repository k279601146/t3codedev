/**
 * Input Indicator â€?floating label showing what Computer Use is doing
 * on the bound window.
 *
 * Displays a small overlay near the bottom of the bound window:
 *   âŒ?Typing "hello world..."
 *   ðŸ–± Click (120, 50)
 *   âŒ?Ctrl+S
 *   ðŸ“œ Scroll â†?3
 *   âœ?Done
...
import { validateHwnd, getTmpDir } from "./shared.ts"
...
// â”€â”€ Convenience methods for common actions â”€â”€
