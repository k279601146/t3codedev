 ...
 *
 * @example capitalize('fooBar') â†?'FooBar'
 * @example capitalize('hello world') â†?'Hello world'
 */
 ...
 *
 * @example plural(1, 'file') â†?'file'
 * @example plural(3, 'file') â†?'files'
 * @example plural(2, 'entry', 'entries') â†?'entries'
 */
 ...
 * Useful for accepting input from Japanese/CJK IMEs (U+3000 â†?U+0020).
 */
