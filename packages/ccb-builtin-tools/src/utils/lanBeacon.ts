/**
 * LAN Beacon â€?UDP multicast peer discovery for Pipes system.
 *
...
// ---------------------------------------------------------------------------
// Module-level singleton â€?avoids (state as any)._lanBeacon hack
// ---------------------------------------------------------------------------
  ...
  start(): void {
    ...
    try {
      ...
      this.socket.on('error', err => {
        logError(err)
        // Non-fatal â€?multicast may not be supported on this network
      })
