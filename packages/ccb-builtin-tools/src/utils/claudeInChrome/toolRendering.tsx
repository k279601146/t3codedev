...
import { renderToolResultMessage as renderDefaultMCPToolResultMessage } from '@claude-code-best/builtin-tools/tools/MCPTool/UI.tsx';
import type { MCPToolResult } from "@t3tools/ccb-engine/src/utils/mcpValidation.ts";
