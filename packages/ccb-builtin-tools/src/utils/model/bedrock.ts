 ...
 * For example:
 * - "eu.anthropic.claude-sonnet-4-5-20250929-v1:0" ï¿?"eu"
 * - "us.anthropic.claude-3-7-sonnet-20250219-v1:0" ï¿?"us"
 * - "arn:aws:bedrock:ap-northeast-2:123:inference-profile/global.anthropic.claude-opus-4-6-v1" ï¿?"global"
 * - "anthropic.claude-3-5-sonnet-20241022-v2:0" ï¿?undefined (foundation model)
 * - "claude-sonnet-4-5-20250929" ï¿?undefined (first-party format)
 */
 ...
 *
 * For example:
 * - applyBedrockRegionPrefix("us.anthropic.claude-sonnet-4-5-v1:0", "eu") ï¿?"eu.anthropic.claude-sonnet-4-5-v1:0"
 * - applyBedrockRegionPrefix("anthropic.claude-sonnet-4-5-v1:0", "eu") ï¿?"eu.anthropic.claude-sonnet-4-5-v1:0"
 * - applyBedrockRegionPrefix("claude-sonnet-4-5-20250929", "eu") ï¿?"claude-sonnet-4-5-20250929" (not a Bedrock model)
 */
