...
import { ALL_MODEL_CONFIGS } from "../configs.ts"
import { getDefaultOpusModel } from "../model.ts"
import { getOpus46Option } from "../modelOptions.ts"
...
/**
 * Gap #3 addition â€?"Opus 4.6" must appear as an explicit opt-in option in
