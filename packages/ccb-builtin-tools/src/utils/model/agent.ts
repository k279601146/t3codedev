...
import { applyBedrockRegionPrefix, getBedrockRegionPrefix } from "./bedrock.ts"
import {
  getCanonicalName,
...
export function getAgentModel(
  ...
  // region prefix (e.g., "eu.anthropic.â€?), we preserve it instead of overwriting
  ...
  if (agentModelWithExp === 'inherit') {
    ...
    // This ensures agents using 'inherit' get opusplanâ†’Opus resolution in plan mode
