import { performBackgroundPluginInstallations } from "@t3tools/ccb-engine/src/services/plugins/PluginInstallationManager.ts";
...
export async function performStartupChecks(setAppState: SetAppState): Promise<void> {
  ...
  try {
    ...
    // would see seed marketplaces as missing â†?clone â†?defeats seed's purpose.
    //
