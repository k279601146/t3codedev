...
import { clearAllOutputStylesCache } from "@t3tools/ccb-engine/src/constants/outputStyles.ts"
import { clearAgentDefinitionsCache } from '@claude-code-best/builtin-tools/tools/AgentTool/loadAgentsDir.ts'
import { clearPromptCache } from '@claude-code-best/builtin-tools/tools/SkillTool/prompt.ts'
...
export function clearAllPluginCaches(): void {
  ...
  // from newly-enabled plugins are NOT added here â€?they wait for
