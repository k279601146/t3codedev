/**
 * BgEngine â€?cross-platform background session engine abstraction.
 *
 * Implementations:
 *   TmuxEngine    â€?macOS/Linux with tmux installed
 *   DetachedEngine â€?Windows, or macOS/Linux without tmux (fallback)
 */
