...
import { setUseCoworkPlugins } from "@t3tools/ccb-engine/src/bootstrap/state.ts"
import {
...
import {
  ...
  VALID_UPDATE_SCOPES,
} from "@t3tools/ccb-engine/src/services/plugins/pluginCliCommands.ts"
...
import { getInstallCounts } from "@t3tools/ccb-engine/src/utils/plugins/installCounts.ts"
import {
  isPluginInstalled,
  loadInstalledPluginsV2,
} from "@t3tools/ccb-engine/src/utils/plugins/installedPluginsManager.ts"
import {
  createPluginId,
...
} from "@t3tools/ccb-engine/src/utils/plugins/marketplaceManager.ts"
import { loadPluginMcpServers } from "@t3tools/ccb-engine/src/utils/plugins/mcpPluginIntegration.ts"
import { parseMarketplaceInput } from "@t3tools/ccb-engine/src/utils/plugins/parseMarketplaceInput.ts"
import {
  parsePluginIdentifier,
  scopeToSettingSource,
} from "@t3tools/ccb-engine/src/utils/plugins/pluginIdentifier.ts"
import { loadAllPlugins } from "@t3tools/ccb-engine/src/utils/plugins/pluginLoader.ts"
import type { PluginSource } from "@t3tools/ccb-engine/src/utils/plugins/schemas.ts"
import {
  type ValidationResult,
  validateManifest,
  validatePluginContents,
} from "@t3tools/ccb-engine/src/utils/plugins/validatePlugin.ts"
...
// marketplace add (lines 5433â€?487)
...
// marketplace list (lines 5497â€?565)
...
// marketplace remove (lines 5576â€?598)
...
// marketplace update (lines 5609â€?672)
...
// plugin install (lines 5690â€?721)
...
// plugin uninstall (lines 5738â€?769)
...
// plugin disable (lines 5833â€?902)
