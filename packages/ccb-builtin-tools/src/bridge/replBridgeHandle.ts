...
import type { ReplBridgeHandle } from "./replBridge.ts"
 ...
 * â€?the handle's closure captures the sessionId and getAccessToken that created
...
export function setReplBridgeHandle(h: ReplBridgeHandle | null): void {
  ...
  // local peers can dedup us out of their bridge list â€?local is preferred.
 ...
 * in /v1/sessions responses â€?or undefined if bridge isn't connected.
 */
