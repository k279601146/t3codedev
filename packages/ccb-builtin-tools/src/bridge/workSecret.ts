...
import type { WorkSecret } from "./types.ts"
 ...
 * and /v1/ for production (Envoy rewrites /v1/ â†?/v2/).
 */
...
export function sameSessionId(a: string, b: string): boolean {
  if (a === b) return true
  // The body is everything after the last underscore â€?this handles both
 ...
 * /v1/code/sessions/{id} â€?the child CC will derive the SSE stream path
