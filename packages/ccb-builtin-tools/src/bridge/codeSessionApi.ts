 ...
 * accessToken + baseUrl â€?no implicit auth or config reads.
 */
...
export async function createCodeSession(
  ...
  try {
    response = await axios.post(
      url,
      // bridge: {} is the positive signal for the oneof runner â€?omitting it
...
/**
 * Credentials from POST /bridge. JWT is opaque â€?do not decode.
