 ...
 * workers). The backend treats this as an opaque string â€?desktop cowork
...
export type BridgeConfig = {
   ...
   * Backend treats this as opaque â€?any string, not just BridgeWorkerType.
   */
  workerType: string
   ...
   * --session-id` resume. Must be a backend-format ID â€?client UUIDs are
   * rejected with 400.
   */
