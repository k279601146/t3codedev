 ...
 *
 * Used by:
 * - `Message.tsx` â€?render SnipBoundaryMessage component.
 * - `QueryEngine.ts` `snipReplay` â€?decide whether to replay the snip
 ...
 *
 * Used by:
 * - `getMessagesAfterCompactBoundary()` in messages.ts â€?after slicing
