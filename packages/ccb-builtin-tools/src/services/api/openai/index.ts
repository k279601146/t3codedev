...
import { toolToAPISchema } from "../../../utils/api.ts"
import {
...
import { recordLLMObservation } from "../../../services/langfuse/tracing.ts"
import {
  convertMessagesToLangfuse,
  convertOutputToLangfuse,
  convertToolsToLangfuse,
} from "../../../services/langfuse/convert.ts"
export {
  isOpenAIThinkingEnabled,
  resolveOpenAIMaxTokens,
  buildOpenAIRequestBody,
...
> {
  try {
    ...
    // 10. Compute max_tokens â€?required by most OpenAI-compatible endpoints.
