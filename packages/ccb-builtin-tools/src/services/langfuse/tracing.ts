...
import { isLangfuseEnabled } from "./client.ts"
import { sanitizeToolInput, sanitizeToolOutput } from "./sanitize.ts"
...
// Root trace is an agent observation â€?represents one full agentic turn/session
...
/**
 * Create a child span under a parent trace â€?used for side queries
