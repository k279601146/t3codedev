...
// URLs stripped of query string and trailing slash â€?matches the normalization
 ...
 * URL is in the official MCP registry. Undefined registry â†?false (fail-closed).
 */
