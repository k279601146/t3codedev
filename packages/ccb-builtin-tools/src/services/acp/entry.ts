...
import { applySafeConfigEnvironmentVariables } from "@t3tools/ccb-engine/src/utils/managedEnv.ts"
...
export async function runAcpAgent(): Promise<void> {
  ...
  // stdout is used for ACP messages â€?redirect console to stderr
