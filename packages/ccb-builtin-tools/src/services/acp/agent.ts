...
import { deserializeMessages } from "@t3tools/ccb-engine/src/utils/conversationRecovery.ts"
import {
  getLastSessionLog,
  sessionIdExists,
} from "@t3tools/ccb-engine/src/utils/sessionStorage.ts"
import { QueryEngine } from "../../QueryEngine.ts"
import type { QueryEngineConfig } from "../../QueryEngine.ts"
import type { Tools } from "@t3tools/ccb-engine/src/Tool.ts"
import { getTools } from "@t3tools/ccb-engine/src/tools.ts"
import { getEmptyToolPermissionContext } from "@t3tools/ccb-engine/src/Tool.ts"
import type { PermissionMode } from "@t3tools/ccb-engine/src/types/permissions.ts"
import type { Command } from "@t3tools/ccb-engine/src/types/command.ts"
import { getCommands } from "../../commands.ts"
import { setOriginalCwd } from "@t3tools/ccb-engine/src/bootstrap/state.ts"
import { enableConfigs } from "@t3tools/ccb-engine/src/utils/config.ts"
import { FileStateCache } from "@t3tools/ccb-engine/src/utils/fileStateCache.ts"
import { getDefaultAppState } from "@t3tools/ccb-engine/src/state/AppStateStore.ts"
import type { AppState } from "@t3tools/ccb-engine/src/state/AppStateStore.ts"
import { createAcpCanUseTool } from "./permissions.ts"
import {
...
import { promptToQueryInput } from "./promptConversion.ts"
import { listSessionsImpl } from "@t3tools/ccb-engine/src/utils/listSessionsImpl.ts"
import { getMainLoopModel } from "@t3tools/ccb-engine/src/utils/model/model.ts"
import { getModelOptions } from "@t3tools/ccb-engine/src/utils/model/modelOptions.ts"
import { getSettings_DEPRECATED } from "@t3tools/ccb-engine/src/utils/settings/settings.ts"
