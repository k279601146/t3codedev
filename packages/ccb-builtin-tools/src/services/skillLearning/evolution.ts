...
export function clusterInstincts(instincts: Instinct[]): EvolutionCandidate[] {
  ...
  return Array.from(groups.values())
    .filter(group => {
      ...
      // persistent policy â€?exactly the H15 risk the threshold guards
