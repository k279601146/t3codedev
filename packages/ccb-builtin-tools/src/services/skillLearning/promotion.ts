...
import type { Instinct, StoredInstinct } from "./instinctParser.ts"
import {
  getInstinctsDir,
  loadInstincts,
  saveInstinct,
...
import { getSkillLearningRoot } from "./observationStore.ts"
 ...
 * behaviour â€?re-promote if we exceed N then forget the oldest â€?is
