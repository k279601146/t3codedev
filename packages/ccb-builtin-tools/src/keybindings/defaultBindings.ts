...
export const DEFAULT_BINDINGS: KeybindingBlock[] = [
  ...
  },
  {
    ...
    bindings: {
      ...
      // ï¿?null-unbinding space hits a pre-existing useKeybinding.ts trap
  ...
  },
  {
    ...
    bindings: {
      ...
      // Toggle/activate the selected setting (space only ï¿?enter saves & closes)
      space: 'select:accept',
  ...
  },
  {
    ...
    bindings: {
      ...
      // q ï¿?pager convention (less, tmux copy-mode). Transcript is a modal
  ...
  },
  {
    ...
    bindings: {
      ...
      // modifier actually reaches the pty ï¿?inert elsewhere.
  ...
  // PromptInput unmounts while cursor active ï¿?no key conflict.
  ...(feature('MESSAGE_ACTIONS')
    ? [
        {
          ...
          bindings: {
            ...
            // meta = cmd on macOS; super for kitty keyboard-protocol ï¿?bind both.
            ...
            // Mouse selection extends on shift+arrow (ScrollKeybindingHandler:573) when present ï¿?
            // correct layered UX: esc clears selection, then shift+ï¿?jumps.
            ...
            // Mirror MESSAGE_ACTIONS. Not imported ï¿?would pull React/ink into this config module.
