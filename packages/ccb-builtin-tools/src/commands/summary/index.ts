/**
 * /summary â€?Generate and display a session summary.
 *
 ...
 */
import type { Command, LocalCommandCall } from "@t3tools/ccb-engine/src/types/command.ts"
...
const call: LocalCommandCall = async (_args, context) => {
  ...
  // call chain (normalizeMessagesForAPI â†?addCacheBreakpoints expects
