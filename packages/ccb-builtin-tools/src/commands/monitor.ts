/**
 * /monitor <command> ï¿?Start a background monitor task.
 *
    ...
    Promise.resolve({
      async call(
        ...
        const { spawnShellTask } =
          require('../tasks/LocalShellTask/LocalShellTask.tsx') as typeof import('../tasks/LocalShellTask/LocalShellTask.tsx')
        const { exec } =
          require('../utils/Shell.ts') as typeof import('../utils/Shell.ts')
        const { getTaskOutputPath } =
          require('../utils/task/diskOutput.ts') as typeof import('../utils/task/diskOutput.ts')
