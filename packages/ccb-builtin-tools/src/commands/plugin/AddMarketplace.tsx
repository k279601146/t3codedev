...
import TextInput from "@t3tools/ccb-engine/src/components/TextInput.ts";
...
import { addMarketplaceSource, saveMarketplaceToSettings } from "@t3tools/ccb-engine/src/utils/plugins/marketplaceManager.ts";
    ...
    <Box flexDirection="column">
      <Box flexDirection="column" paddingX={1} borderStyle="round">
        ...
        <Box flexDirection="column">
          ...
          <Text dimColor> 路 owner/repo (GitHub)</Text>
          <Text dimColor> 路 git@github.com:owner/repo.git (SSH)</Text>
          <Text dimColor> 路 https://example.com/marketplace.json</Text>
          <Text dimColor> 路 ./path/to/marketplace</Text>
          <Box marginTop={1}>
            <TextInput
              value={inputValue}
        ...
        {isLoading && (
          <Box marginTop={1}>
            <Spinner />
            <Text>{progressMessage || 'Adding marketplace to configuration鈥?}</Text>
          </Box>
        )}
        {error && (
          <Box marginTop={1}>
