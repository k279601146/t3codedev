import { getPluginErrorMessage, type PluginError } from "@t3tools/ccb-engine/src/types/plugin.ts";
...
export function getErrorGuidance(error: PluginError): string | null {
  switch (error.type) {
    ...
    case 'mcp-server-suppressed-duplicate': {
      // duplicateOf is "plugin:name:srv" when another plugin won dedup â€?
