...
import type { Command, LocalCommandCall } from "../types/command.ts"
 ...
 * services/compact/snipCompact.ts) detects this boundary and removes â€?or
 * collapses â€?the older messages so they no longer consume context-window
