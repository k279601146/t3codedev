...
import { getBridgeDisabledReason, isBridgeEnabled } from "../../bridge/bridgeEnabled.ts";
import { getBridgeAccessToken } from "../../bridge/bridgeConfig.ts";
import { BRIDGE_LOGIN_INSTRUCTION } from "../../bridge/types.ts";
import { Dialog } from "@t3tools/ccb-engine/src/components/design-system/Dialog.ts";
import { ListItem } from "@t3tools/ccb-engine/src/components/design-system/ListItem.ts";
import { useRegisterOverlay } from "../../context/overlayContext.tsx";
import { Box, Text } from '@anthropic/ink';
import { useKeybindings } from "../../keybindings/useKeybinding.ts";
import { buildCliLaunch, spawnCli } from "@t3tools/ccb-engine/src/utils/cliLaunch.ts";
...
/**
 * /remote-control-server command â€?manages the daemon-backed persistent bridge server.
 *
