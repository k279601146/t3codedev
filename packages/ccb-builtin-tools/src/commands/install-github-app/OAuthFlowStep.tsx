...
import { saveOAuthTokensIfNeeded } from "@t3tools/ccb-engine/src/utils/auth.ts";
    ...
    switch (oauthStatus.state) {
      case 'starting':
        return (
          <Box>
            <Spinner />
            <Text>Starting authenticationâ€?/Text>
          </Box>
        );
        ...
        return (
          <Box flexDirection="column" gap={1}>
            {!showPastePrompt && (
              <Box>
                <Spinner />
                <Text>Opening browser to sign in with your Claude accountâ€?/Text>
              </Box>
            )}
      ...
      case 'processing':
        return (
          <Box>
            <Spinner />
            <Text>Processing authenticationâ€?/Text>
          </Box>
        );
      ...
      case 'success':
        return (
          <Box flexDirection="column" gap={1}>
            <Text color="success">âœ?Authentication token created successfully!</Text>
            <Text dimColor>Using token for GitHub Actions setupâ€?/Text>
          </Box>
        );
