...
function setEffortValue(effortValue: EffortValue): EffortCommandResult {
  ...
  // conflicts â€?if env matches what the user just asked for, the outcome is
  ...
  if (envOverride !== undefined && envOverride !== effortValue) {
    ...
    return {
      message: `CLAUDE_CODE_EFFORT_LEVEL=${envRaw} overrides this session â€?clear it and ${effortValue} takes over`,
      effortUpdate: { value: effortValue },
    };
  }
