...
import { ContextVisualization } from "@t3tools/ccb-engine/src/components/ContextVisualization.ts";
...
import { analyzeContextUsage } from "@t3tools/ccb-engine/src/utils/analyzeContext.ts";
import { getMessagesAfterCompactBoundary } from "@t3tools/ccb-engine/src/utils/messages.ts";
import { renderToAnsiString } from "@t3tools/ccb-engine/src/utils/staticRender.tsx";
 ...
 * was collapsed â€?user sees "180k, 3 spans collapsed" when the API sees 120k.
 */
