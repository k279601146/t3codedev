import { queryHaiku } from "@t3tools/ccb-engine/src/services/api/claude.ts"
...
import { extractTextContent } from "@t3tools/ccb-engine/src/utils/messages.ts"
import { extractConversationText } from "@t3tools/ccb-engine/src/utils/sessionTitle.ts"
...
export async function generateSessionName(
  ...
  try {
    ...
    // Haiku timeout/rate-limit/network are expected operational failures â€?
