...
import { getAdditionalDirectoriesForClaudeMd, setAdditionalDirectoriesForClaudeMd } from "@t3tools/ccb-engine/src/bootstrap/state.ts";
...
import { AddWorkspaceDirectory } from "@t3tools/ccb-engine/src/components/permissions/rules/AddWorkspaceDirectory.ts";
import { Box, Text } from '@anthropic/ink';
import type { LocalJSXCommandOnDone } from "@t3tools/ccb-engine/src/types/command.ts";
import { applyPermissionUpdate, persistPermissionUpdate } from "@t3tools/ccb-engine/src/utils/permissions/PermissionUpdate.ts";
import type { PermissionUpdateDestination } from "@t3tools/ccb-engine/src/utils/permissions/PermissionUpdateSchema.ts";
import { SandboxManager } from "@t3tools/ccb-engine/src/utils/sandbox/sandbox-adapter.ts";
