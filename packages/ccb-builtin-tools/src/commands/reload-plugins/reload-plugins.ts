...
import { redownloadUserSettings } from "@t3tools/ccb-engine/src/services/settingsSync/index.ts"
...
export const call: LocalCommandCall = async (_args, context) => {
  ...
  // with whoever writes settings ï¿?the file watcher delivers changes, no
