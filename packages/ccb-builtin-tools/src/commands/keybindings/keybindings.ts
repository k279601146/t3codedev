...
} from "../../keybindings/loadUserBindings.ts"
import { generateKeybindingsTemplate } from "../../keybindings/template.ts"
...
export async function call(): Promise<{ type: 'text'; value: string }> {
  ...
  // Write template with 'wx' flag (exclusive create) â€?fails with EEXIST if
