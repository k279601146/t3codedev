...
import {
  removeSlaveClient,
  getAllSlaveClients,
} from "../../hooks/useMasterMonitor.ts"
import { getPipeIpc, isPipeControlled } from "@t3tools/ccb-engine/src/utils/pipeTransport.ts"
...
export const call: LocalCommandCall = async (args, context) => {
  ...
  // No target specified â€?detach from ALL slaves
