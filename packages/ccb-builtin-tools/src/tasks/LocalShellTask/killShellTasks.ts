...
import { dequeueAllMatching } from "@t3tools/ccb-engine/src/utils/messageQueueManager.ts"
...
export function killShellTasksForAgent(
  ...
  // Purge any queued notifications addressed to this agent â€?its query loop
