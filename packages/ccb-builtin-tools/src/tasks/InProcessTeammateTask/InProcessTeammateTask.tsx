...
import type { Message, MessageOrigin } from "@t3tools/ccb-engine/src/types/message.ts";
import { logForDebugging } from "@t3tools/ccb-engine/src/utils/debug.ts";
import { createUserMessage } from "@t3tools/ccb-engine/src/utils/messages.ts";
import { killInProcessTeammate } from "@t3tools/ccb-engine/src/utils/swarm/spawnInProcess.ts";
import { updateTaskState } from "@t3tools/ccb-engine/src/utils/task/framework.ts";
import type { InProcessTeammateTaskState, PendingTeammateUserMessage } from "./types.ts";
 ...
 * and useBackgroundTaskNavigation â€?selectedIPAgentIndex maps into this
