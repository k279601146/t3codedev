...
/**
 * Tools that workers must NOT have â€?these are coordinator-only
...
Guidelines:
- Complete the task fully â€?don't leave it half-done, but don't gold-plate either.
...
- Report back with actionable findings â€?the coordinator will synthesize your results.
