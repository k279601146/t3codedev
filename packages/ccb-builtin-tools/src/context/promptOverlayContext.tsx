 ...
 * bottom="100%"` to float above the prompt â€?and Ink's clip stack
 * intersects ALL descendants, so they were clipped to ~1 row.
 *
 * Two channels:
 * - `useSetPromptOverlay` â€?slash-command suggestion data (structured,
 *   written by PromptInputFooter)
 * - `useSetPromptOverlayDialog` â€?arbitrary dialog node (e.g.
 ...
 * their own writes â€?the setter contexts are stable.
 */
