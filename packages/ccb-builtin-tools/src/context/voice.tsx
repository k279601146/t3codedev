...
export function VoiceProvider({ children }: Props): React.ReactNode {
  // Store is created once â€?stable context value means the provider never
...
/**
 * Get the voice state setter. Stable reference â€?never causes re-renders.
 ...
 * useVoiceState (which subscribes), this doesn't cause re-renders â€?use
