...
/**
 * Set by FullscreenLayout when rendering content in its `modal` slot â€?
 * the absolute-positioned bottom-anchored pane for slash-command dialogs.
 * Consumers use this to:
 *
 * - Suppress top-level framing â€?`Pane` skips its full-terminal-width
 *   `Divider` (FullscreenLayout already draws the â–?divider).
 * - Size Select pagination to the available rows â€?the modal's inner
 ...
 * - Reset scroll on tab switch â€?Tabs keys its ScrollBox by
 ...
 * component caps its visible content height â€?the modal's inner area is
