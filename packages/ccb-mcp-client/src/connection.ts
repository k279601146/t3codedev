// MCP connection utilities 鈥?protocol-level helpers for establishing and managing connections
...
import type { ConnectedMCPServer, ScopedMcpServerConfig } from "./types.ts"
 ...
 * SIGINT (100ms) 鈫?SIGTERM (400ms) 鈫?SIGKILL
 *
