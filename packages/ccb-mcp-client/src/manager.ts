// McpManager 鈥?imperative API for MCP protocol client
// Factory function that creates a manager instance with event-based notifications

import type { Client } from '@modelcontextprotocol/sdk/client/index.js'
import type { ListToolsResult } from '@modelcontextprotocol/sdk/types.js'
import memoize from "lodash-es/memoize.js"
import { buildMcpToolName } from "./strings.ts"
import type { CoreTool } from '@claude-code-best/agent-tools/index.ts'
import type {
  McpServerConfig,
...
import type { McpClientDependencies } from "./interfaces.ts"
import { McpConnectionError, McpAuthError, McpTimeoutError } from "./errors.ts"
import { memoizeWithLRU } from "./cache.ts"
import { discoverTools } from "./discovery.ts"
import { callMcpTool } from "./execution.ts"
...
class McpManagerImpl implements McpManager {
  ...
  /** Set the connect function 鈥?the host provides this with all transport logic */
  setConnectFn(
    fn: (
      name: string,
      config: ScopedMcpServerConfig,
