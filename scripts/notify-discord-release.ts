  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Bahew prerelease is available for nightly testers."
          : "A new Bahew latest release is available.",
...
).pipe(Command.withDescription("Post a Bahew release announcement to Discord."));
